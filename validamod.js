const form = document.getElementById("change_");
...
form.addEventListener("submit", function (event) {
    ...
    let messages = [];
    if (username.value.length != 0 && (username.value.length <= 3 || username.value.length > 10)) {
    ...
    if (nombre.value.length != 0 && (nombre.value.length < 3 || nombre.value.length > 10)) {
    ...
    if (apellido.value.length!=0 && (apellido.value.length < 3 || apellido.value.length > 10)) {
    ...
    if (correo.value.length != 0 && (validateEmail(correo.value) === false || correo.value.length > 32)) {
    ...
    if (telefono.value.length==0 && correo.value.length==0 && apellido.value.length==0 && nombre.value.length==0 && username.value.length==0 && contraseña1.value.length==0){
        messages.push("⚠ Rellena algun campo.");
    }
    if (contraseña1.value.length != 0 && (contraseña1.value.length < 8 || validarCadena(contraseña1.value) === false)){
